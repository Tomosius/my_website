...
if (!/^https?:\/\//i.test(siteUrl)) {
  console.warn('[sitemap] WARNING: siteUrl is missing or not http(s). Set config/site.json or SITE_URL.');
}
...
console.log(`[sitemap] Generated ${urls.length} URL(s) → build/sitemap.xml and robots.txt using ${siteUrl || '(unset siteUrl)'}`);